...
namespace AI_stats_measurement.Backend.Migrations
{
    ...
    [Migration("20260511125210_MakeExportRowModelResponseNullablefix")]
    partial class MakeExportRowModelResponseNullablefix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AI_stats_measurement.Backend.Models.LlmJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ModelResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AI_stats_measurement.Backend.Models.ExportRow", b =>
                {
                    b.HasOne("ModelResponse", "ModelResponse")
                        .WithMany()
                        .HasForeignKey("ModelResponseId")
            ...
            modelBuilder.Entity("ModelResponse", b =>
                {
                    b.HasOne("AI_stats_measurement.Backend.Models.LlmJob", "Job")
